...
const cases = [
  // Colección "pacientes"
  {
    name: 'anónimo NO puede leer pacientes',
    req: { path: '/pacientes/doc1', method: 'get', auth: null, resource: { ownerId: 'alice' } },
    expect: 'DENY',
  },
  {
    name: 'dueño SÍ puede leer pacientes',
    req: { path: '/pacientes/doc1', method: 'get', auth: { uid: 'alice' }, resource: { ownerId: 'alice' } },
    expect: 'ALLOW',
  },
  {
    name: 'otro usuario NO puede leer pacientes',
    req: { path: '/pacientes/doc1', method: 'get', auth: { uid: 'mallory' }, resource: { ownerId: 'alice' } },
    expect: 'DENY',
  },
  // Colección "pagos"
  {
  ...
  // Colección "citas"
  {
    name: 'anónimo NO puede leer citas',
    req: { path: '/citas/doc1', method: 'get', auth: null, resource: { ownerId: 'alice' } },
    expect: 'DENY',
  },
  {
    name: 'dueño SÍ puede leer citas',
    req: { path: '/citas/doc1', method: 'get', auth: { uid: 'alice' }, resource: { ownerId: 'alice' } },
    expect: 'ALLOW',
  },
  {
    name: 'otro usuario NO puede leer citas',
    req: { path: '/citas/doc1', method: 'get', auth: { uid: 'mallory' }, resource: { ownerId: 'alice' } },
    expect: 'DENY',
  },
  // Colección "resenas"
  {
    name: 'anónimo NO puede leer resenas',
    req: { path: '/resenas/doc1', method: 'get', auth: null, resource: { ownerId: 'alice' } },
    expect: 'DENY',
  },
  {
    name: 'dueño SÍ puede leer resenas',
    req: { path: '/resenas/doc1', method: 'get', auth: { uid: 'alice' }, resource: { ownerId: 'alice' } },
    expect: 'ALLOW',
  },
  {
    name: 'otro usuario NO puede leer resenas',
    req: { path: '/resenas/doc1', method: 'get', auth: { uid: 'mallory' }, resource: { ownerId: 'alice' } },
    expect: 'DENY',
  },
  // Colección "usuarios"
  {
